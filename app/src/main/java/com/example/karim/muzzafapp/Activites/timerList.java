...
import com.example.karim.muzzafapp.Brodcast.MyReceiver;
        ...
        mTimeRef.child("Time").child("hours").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                mReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        final String phoneNumber= shared.Email;
                        if(dataSnapshot.hasChild(phoneNumber)){
                            ...
                            stTimer=timerData;
                            mReference.setValue(shared.Email).addOnSuccessListener(new OnSuccessListener<Void>() {
                                @Override
                                public void onSuccess(Void aVoid) {
                                    mReference.child(shared.Email).setValue(timerData.getDate()).addOnSuccessListener(new OnSuccessListener<Void>() {
                                        @Override
                                        public void onSuccess(Void aVoid) {
                                            mReference.child(shared.Email).setValue(timerData.getDate()).addOnSuccessListener(new OnSuccessListener<Void>() {
                                                @Override
                                                public void onSuccess(Void aVoid) {
                                                    mReference.child(shared.Email).child(timerData.getDate()).setValue(timerData).addOnSuccessListener(new OnSuccessListener<Void>() {
                                                        @Override
                                                        public void onSuccess(Void aVoid) {
                                                            StartTimer(EndTime);
